...
public class testAnnotation {
    ...
    public static void main(String[] args) {
        try {
            org.jsoup.nodes.Document document = Jsoup.parse(new File("/home/wbt/work/pano/src/main/webapp/xml/templet.xml"), "utf-8");

            Element body = document.select("body").first();
            Element krpano = body.select("krpano").first();
            krpano.prepend("<scene name=\"scene_271914\" pano_id=\"271914\"></scene>");
            krpano.append("");
